...
// Generate analysis results with scores mostly in 60-80 range
function generateAnalysisResults() {
    // Generate scores mostly in 60-80 range with occasional outliers
    const hairScoreValue = normalRandom(50, 90, 1);
    const jawlineScoreValue = normalRandom(50, 90, 1);
    const facialStructureScoreValue = normalRandom(50, 90, 1);
    const skinQualityScoreValue = normalRandom(50, 90, 1);
    const eyeAreaScoreValue = normalRandom(50, 90, 1);
